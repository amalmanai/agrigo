...
public class QrCodeUtil {
    ...
    public static String decodeFromFile(File file) throws IOException, NotFoundException {
        ...
        if (bufferedImage == null) {
            throw new IOException("Image non lisible ou format non supporté. Formats supportés: PNG, JPG, JPEG.");
        }
        ...
        try {
            ...
            throw new IOException("Erreur lors du décodage du QR code: " + e.getMessage(), e);
        }
    }
