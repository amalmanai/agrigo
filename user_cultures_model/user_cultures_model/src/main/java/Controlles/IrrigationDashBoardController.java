...
public class IrrigationDashBoardController {
    ...
    @FXML private Tab tabRapports;
    @FXML private StackPane rapportContentPlaceholder;
    ...
    @FXML private Button btnNavHistorique, btnNavSystemes, btnNavRapports;
    ...
    private void loadRapportView() {
        if (rapportContentPlaceholder == null) return;
        try {
            Parent rapportRoot = FXMLLoader.load(getClass().getResource("/rapportIrrigation.fxml"));
            rapportContentPlaceholder.getChildren().setAll(rapportRoot);
        } catch (IOException e) {
    ...
    @FXML
    void showRapports() {
        selectTab(tabRapports);
        setActiveNav(btnNavRapports);
    }
    ...
    private void setActiveNav(Button active) {
        Button[] buttons = { btnNavHistorique, btnNavSystemes, btnNavRapports };
    ...
    private void setupTabSync() {
        ...
        mainTabs.getSelectionModel().selectedItemProperty().addListener((o, old, n) -> {
            if (brandTitle != null) brandTitle.setText(n == tabSystemes ? "Systèmes" : (n == tabRapports ? "Rapports" : "Irrigation"));
            if (searchField != null) searchField.setPromptText(n == tabSystemes ? "Rechercher un système..." : (n == tabRapports ? "Rechercher..." : "Rechercher une irrigation..."));
            applyFiltering();
        });
    }
