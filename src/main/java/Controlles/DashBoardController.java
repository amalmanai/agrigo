...
public class DashBoardController {
    ...
    @FXML private Label lblZonesCritiques;
    @FXML private Label lblZonesSurveillance;
    @FXML private Label lblZonesStables;
    ...
    private void updateAdvancedAnalytics(List<Alerte> alertes, WeatherService.RiskSummary weatherSummary) {
        ...
        if (lblZonesCritiques != null) {
            lblZonesCritiques.setText(String.valueOf(criticalCount));
        }
        if (lblZonesSurveillance != null) {
            lblZonesSurveillance.setText(String.valueOf(watchCount));
        }
        if (lblZonesStables != null) {
            lblZonesStables.setText(String.valueOf(stableCount));
        }
